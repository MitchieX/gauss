...
if(isset($_POST['email'])) {
    ...
    $email_to = "contato@gaussinspecoes.com.br";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.gaussinspecoes.com.br/');</script>";
